...
Blockly.JavaScript['math_constant'] = function(block) {
  ...
  var CONSTANTS = {
    'PI': ['Mathf.PI', Blockly.JavaScript.ORDER_MEMBER],
    'E': ['Mathf.Epsilon', Blockly.JavaScript.ORDER_MEMBER],
    'GOLDEN_RATIO':
        ['(1 + Mathf.Sqrt(5)) / 2', Blockly.JavaScript.ORDER_DIVISION],
    'SQRT2': ['Mathf.SQRT2', Blockly.JavaScript.ORDER_MEMBER],
    'SQRT1_2': ['Mathf.SQRT1_2', Blockly.JavaScript.ORDER_MEMBER],
...
Blockly.JavaScript['math_on_list'] = function(block) {
  ...
  switch (func) {
    ...
    case 'MIN':
      ...
      code = 'Mathf.Min(null, ' + list + ')';
      break;
    case 'MAX':
      list = Blockly.JavaScript.valueToCode(block, 'LIST',
          Blockly.JavaScript.ORDER_COMMA) || '[]';
      code = 'Mathf.Max(null, ' + list + ')';
      break;
    case 'AVERAGE':
    ...
    case 'RANDOM':
      var functionName = Blockly.JavaScript.provideFunction_(
          ...
          ['function ' + Blockly.JavaScript.FUNCTION_NAME_PLACEHOLDER_ +
              '(list) {',
            '  var x = Mathf.Floor(Random.value * list.length);',
            '  return list[x];',
            '}']);
      list = Blockly.JavaScript.valueToCode(block, 'LIST',
          Blockly.JavaScript.ORDER_NONE) || '[]';
...
Blockly.JavaScript['math_random_int'] = function(block) {
  ...
  var functionName = Blockly.JavaScript.provideFunction_(
      ...
      ['function ' + Blockly.JavaScript.FUNCTION_NAME_PLACEHOLDER_ +
       ...
       '    b = c;',
       '  }',
       '  return Mathf.Floor(Random.value * (b - a + 1) + a);',
       '}']);
...
Blockly.JavaScript['math_random_float'] = function(block) {
  ...
  return ['Random.value', Blockly.JavaScript.ORDER_FUNCTION_CALL];
};
